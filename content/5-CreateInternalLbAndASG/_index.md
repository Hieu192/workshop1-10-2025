...
---
#### Introduction
In this section, we will create an **Internal Load Balancer** to balance the traffic from the Web Tier to the App Tier and an **Auto Scaling Group** for the App Tier.
